...
kernel void r_512_8_4_4_256(device float* data0_8192, device float* data1_2048, device float* data2_16777216, uint3 gid [[threadgroup_position_in_grid]], uint3 lid [[thread_position_in_threadgroup]]) {
  ...
  *(acc0+3) = 0.0f;
  for (int Ridx0 = 0; Ridx0 < 256; Ridx0++) {
    float val0 = (*(data1_2048+(lidx0+(Ridx0<<3))));
    int alu5 = (alu0+(lidx0<<13)+(Ridx0<<16));
    float val1 = (*(data2_16777216+alu5));
    float val2 = (*(data2_16777216+(alu5+4)));
    float val3 = (*(data2_16777216+(alu5+8)));
    float val4 = (*(data2_16777216+(alu5+12)));
  ...
  *(acc1+3) = 0.0f;
  ...
  bool alu23 = (lidx0==0);
  if (alu23) {
    *(data0_8192+alu0) = (*(acc1+0));
  }
  if (alu23) {
    *(data0_8192+(alu0+4)) = (*(acc1+1));
  }
  if (alu23) {
    *(data0_8192+(alu0+8)) = (*(acc1+2));
  }
  if (alu23) {
    *(data0_8192+(alu0+12)) = (*(acc1+3));
  }
}
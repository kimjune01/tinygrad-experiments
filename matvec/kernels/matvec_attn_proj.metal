...
kernel void r_256_8_4_4_512(device float* data0_4096, device float* data1_4096, device float* data2_16777216, uint3 gid [[threadgroup_position_in_grid]], uint3 lid [[thread_position_in_threadgroup]]) {
